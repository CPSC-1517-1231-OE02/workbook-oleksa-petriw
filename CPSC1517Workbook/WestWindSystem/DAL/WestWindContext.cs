...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        //=> optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=WestWind;TrustServerCertificate=True;Trusted_Connection=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BuildVer__3214EC075D746E04");
        ...
        {
            entity.HasKey(e => e.ManifestItemId).HasName("PK__Manifest__9000192CD2B9174B");
        ...
        {
            entity.HasKey(e => e.ShipmentId).HasName("PK__Shipment__5CAD378D125FFE97");
